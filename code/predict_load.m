...
%% input historical temperature and electricity load
...
%        ML_fit_data{h,1} = {};
    ...
    % and temperature for 10 utilities. It is then randomly distributed over the 123 nodes.
